...
2. В отчете Allure вы увидите:
   - **Название теста**: 1. `Тестирование калькулятора: 7 + 8 = 15`.
   ...
   - **Название теста**: 2. `Тестирование магазина`
   - **Описание теста**: Тест проверяет корректность работы магазина и его функций.
   - **Шаги теста**:
   ...
   - **Результат**: Успешное выполнение или ошибка с учетом ожидаемого и фактического результата.
